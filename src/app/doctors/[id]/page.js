            ...
            <div className="mt-2">
              <div className="flex justify-between items-center my-3">
                <div className="flex items-center gap-1">
                  <span>{doctorInfo.genderIcon}</span>
                  <h1 className="font-semibold text-[13px]">Gender</h1>
                </div>
                <h1 className="text-sm">{doctorInfo.gender}</h1>
              </div>
              <div className="flex justify-between items-center my-3">
                <div className="flex items-center gap-1">
                ...
                <h1 className="text-sm">{doctorInfo.hospital}</h1>
              </div>
              <div className="flex justify-between items-center my-3">
                <div className="flex items-center gap-1">
                  <span>{<IoMdTime />}</span>
                ...
                <h1 className="text-sm">{doctorInfo.appointmentTime}</h1>
              </div>
              <div className="flex justify-between items-center my-3">
                <div className="flex items-center gap-1">
                  <span>{<AiOutlineDollar />}</span>
                  <h1 className="font-semibold text-[13px]">Fees</h1>
                </div>
                <h1 className="text-sm">{doctorInfo.fees}</h1>
              </div>
              <hr className="h-[1px] bg-[#e2e2e2] border-none" />
              <DatePicker/>
              <Button className={"h-auto w-full text-xs"}>
